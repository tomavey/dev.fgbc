...
<script type="text/javascript" src="/files/plugins/richtext/ckeditor/ckeditor.js"></script>
...
<body>
<div id="container">
<div id="header"><h1><a href="/fc/">Fellowship Council Web Site</a> 
<cfif isdefined("attribute.sectionheader")> - <cfoutput>#attribute.sectionheader#</cfoutput></cfif></h1></div>
<div id="wrapper">
