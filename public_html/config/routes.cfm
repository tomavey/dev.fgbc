...
<!---------------------------------->
		...
		.namespace("membership")
			.controller("applications")
				.get(name="newApp", pattern="/applications/", action="index")
				.get(name="showApp", pattern="/application/", action="show")
				.get(name="editApp", pattern="/application/edit/", action="edit")
				.get(name="deleteApp", pattern="/application/delete/", action="delete")
