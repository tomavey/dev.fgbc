...
<!---------------------------------->
		...
		.namespace("handbook")
			...
			.get(name="organizations", pattern="/organizations/[key]", controller="organizations", action="show")
			...
			.get(name="organization", pattern="organization/", controller="organizations", action="show")
