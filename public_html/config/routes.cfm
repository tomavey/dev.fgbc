...
.namespace("auth")
			...
			.controller("users")
				.get(name="index", pattern="/", action="index")
				.get(name="xindex", pattern="x/", action="xindex")
				.get(name="show", pattern="show/")
				.get(name="edit", pattern="edit/")
				.get(name="new", pattern="new/")
				.delete(name="delete", pattern="delete/")
				...
				.get(name="copy", pattern="copy")
				.get(name="list", pattern="list")
				.post(name="confirmCode", pattern="confirmCode/")
				.put(name="confirmCode", pattern="confirmCode/")
				.get(name="confirmCode", pattern="confirmCode/")
...
<!---------------------------------->
		...
		.namespace("handbook")
			...
			.get(name="agbmPaymentsList", pattern="/agbmInfo/paymentslist/", controller="agbmInfo", action="paymentsList")
			...
			.get(name="orphanedPositions", pattern="/positions/orphaned/", controller="positions", action="orphanedPositions")
			.get(name="deleteOrphanedPositions", pattern="/positions/orphaned/delete/", controller="positions", action="deleteOrphanedPositions")
...
<!---------------------------------->
		...
		.namespace("conference")
			...
			.get(name="history", pattern="/exhibits/history/", controller="exhibits", action="history")
			...
			.get(name="sendAnnouncement", pattern="/announcements/send/", controller="announcements", action="sendAnnouncement")
			.get(name="approveAnnouncement", pattern="/announcement/approve/", controller="announcements", action="approve")
			.get(name="notifyAnnouncement", pattern="/announcement/notification/", controller="announcements", action="notification")
			.get(name="deleteAnnouncement", pattern="/announcement/delete", controller="announcements", action="delete")
			.get(name="copyAnnouncement", pattern="/announcement/copy", controller="announcements", action="copy")
...
<!---Main page routes--->
    ...
    .get(name="conferencemyreg", pattern="/conference/myregs/", controller="conference.users", action="my-regs")
		...
		.get(name="cci_es", pattern="/ccies", controller="about", action="cci_es")
		.get(name="ccci_es", pattern="/cccies", controller="about", action="cci_es")
...
<!---------------------------------->
		...
		.get(name="apiOtherEvents", pattern="/api/otherevents/", controller="conference.events", action="listOtherEventsAsJson")
