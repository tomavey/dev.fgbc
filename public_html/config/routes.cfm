	...
	drawRoutes()
		...
		.namespace("handbook")
			...
			.controller("organizations")
				.get(name="handbookPagesEdit", pattern="/organizations/handbookpages/[key]", action="handbookpages")
				.get(name="move", pattern="/organizations/move/", action="move")
				.get(name="removeStaff", pattern="/organizations/removeStaff/[key]", action="notStaff")
				.get(name="downloadguidelines", pattern="/organizations/downloadguidelines/", action="downloadguidelines")
				.get(name="downloadmembers", pattern="/organizations/downloadmemberchurches/", action="downloadMemberChurches")
				.get(name="downloadMemberChurchesForBrotherhoodPreview", pattern="/organizations/brotherhood/preview/", action="downloadMemberChurchesForBrotherhood")
				.get(name="downloadMemberChurchesForBrotherhood", pattern="/organizations/brotherhood/[key]", action="downloadMemberChurchesForBrotherhood")
				.get(name="downloadMemberChurchesForBrotherhood", pattern="/brotherhood/[key]", action="downloadMemberChurchesForBrotherhood")
				.get(name="updatelinks", pattern="/organizations/updatelinks/", action="updatelinks")
				.get(name="yellowpages", pattern="/organizations/yellowpages/", action="yellowpages")
				.get(name="prayerlist", pattern="/organizations/prayerlist/", action="prayerlist")
