...
<cfscript>
	drawRoutes()
		...
		.namespace("handbook")
			...
			.get(name="downloadMemberChurchesForBrotherhoodPreview", pattern="/organizations/brotherhood/", controller="organizations", action="downloadMemberChurchesForBrotherhood")
