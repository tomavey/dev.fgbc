...
<p>&nbsp;</p>
  ...
  <cfoutput query="churches" group="state"><!---Each State--->
    <span style="font-family:'Times New Roman';font-size:22pt">#state#</span><br/>

    <cfoutput group="listed_as_city"><!---Each City--->
      ...
      <br/>
        <cfif len(address1)>
        <span style="font-family:'Times New Roman';font-size:9pt;">#fixAddress(address1)#</span><br/>
        </cfif>
        <cfif len(address2)>
        <span style="font-family:'Times New Roman';font-size:9pt;">#fixAddress(address2)#</span><br/>
        </cfif>
        <span style="font-family:'Times New Roman';font-size:9pt;">#fixAddress(org_city)#, #state_mail_abbrev# #zip#</span><br/>
      ...
      <cfoutput>
        ...
        <cfif isDefined("params.showreview")>
          ...
          <p>
            Last reviewed on #dateformat(reviewedAt)# by #reviewedBy#<br/>
            Last updated: #dateformat(updatedAt)#
          </p>
