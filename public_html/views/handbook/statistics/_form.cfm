<cfoutput>			
	...
	#textField(objectName='handbookstatistic', property='att', label='Average Weekly Attendance: ', class="tooltiptop", title="Your churches average weekly attendance in #handbookstatistic.year#")#
	...
	#textField(objectName='handbookstatistic', property='conversions', label='Professions of faith (conversions): ', class="tooltiptop", title="How first-time professions of faith (salvation) in in #handbookstatistic.year#")#
					
	#textField(objectName='handbookstatistic', property='baptisms', label='Total Baptisms: ', class="tooltiptop", title="How many baptisms in #handbookstatistic.year#")#
					
	#textField(objectName='handbookstatistic', property='members', label='Total Number of Members: ', class="tooltiptop", title="How many members did you have on December 31, #handbookstatistic.year#")#
