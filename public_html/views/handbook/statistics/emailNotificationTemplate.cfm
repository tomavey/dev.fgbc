        ...
        <table>
            <tr>
                <td>
                    ...
                    <p>
                        Each year, Charis Fellowship churches agree to send a simple statistical report for the previous year and a fellowship fee for the current year. This is a friendly reminder that stats for #year(now())-1#17 and the fellowship fee for #year(now())# are due May 15.  After that date, the fee increases. Your office should have received #linkto(text="this brochure", href="http://charisfellowship.us/files/FGBCStatCard2017-18.pdf")# by regular post requesting your statistics and fellowship fee.
                    </p>
                    <p class="callout">
