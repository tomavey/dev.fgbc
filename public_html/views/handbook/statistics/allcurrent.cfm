			...
			<cfif not isDownload>
				...
				<cfif gotRights("superadmin,office")>
					...
					<cfif isBefore("August 1, #year(now())#") && isAfter("February 1, #year(now())#")>
						<cfset body = "Greetings! %0D%0A%0D%0AWe are working on the membership and stat report for the Charis Fellowship and would like to complete it as soon as possible. %0D%0A%0D%0APlease take a moment and use this link to submit the stat and payment for the fellowship fee https://charisfellowship.us/sendstats/#id#. %0D%0A%0D%0ACan I help you accomplish this? Through the generosity of fellowship churches, we can cover your churches fellowship fee (in part or whole).  Just fill out the stat form at https://charisfellowship.us/sendstats/42 and let me know you need help.%0D%0A%0D%0AIf you believe this to be an error, please contact our office so we can keep our information up to date.  %0D%0A%0D%0ASharmion Bowell%0D%0A574-269-1269">
					<cfelse>
