...
<cfoutput>
<h2 style="text-align:center;"> THE ASSOCIATION OF GRACE BRETHREN MINISTERS<br/> RECOGNIZED NATIONALLY AS OF SEPTEMBER 30, #currentMembershipYear#</h2>
</cfoutput>

<p style="text-align:center;">MINISTERS MUST BE MEMBERS OF GRACE BRETHREN CHURCHES WHICH APPROVE THEIR SERVICE AS ELDERS. <br/> THE MEMBERSHIP FEE IS $100, DUE EVERY YEAR IN APRIL AND MAY.<p>
...
<cfoutput>
<p style="font-size:.8em">(Based on membership payment records recorded for #currentMembershipYear#)</p>
</cfoutput>
