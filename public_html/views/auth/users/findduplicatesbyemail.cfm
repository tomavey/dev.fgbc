...
<table>
  <cfoutput>
    <tr>
      ...
      <th>#linkto(text="Email", route="AuthUsersfindDuplicatesByEmail", params="orderBy=email&direction=ASC")#</th>
      <th>#linkto(text="Created", route="AuthUsersfindDuplicatesByEmail", params="orderBy=createdat&direction=DESC")#</th>
      <th>#linkto(text="Last Logged in", route="AuthUsersfindDuplicatesByEmail", params="orderBy=lastloginat&direction=DESC")#</th>
    </tr>
  </cfoutput>
