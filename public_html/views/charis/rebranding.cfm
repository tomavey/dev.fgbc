    <section class="g-py-100" id="rebrand">
        <div class="container">
      <!-- Login modal window -->
      <div id="rebrand" class="text-left g-bg-white g-overflow-y-auto g-pa-20" style="display: block;">
        ...
        <div class="card text-center">
          ...
          <iframe src="https://player.vimeo.com/video/241833716" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            <p>
                <a href="https://vimeo.com/241833716">Charis Fellowship Live Stream - Recorded</a> from <a href="https://vimeo.com/charisfellowship">Charis Fellowship</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
            </p>
        </div>
        <div class="card text-center">
          <p class="embed-responsive embed-responsive-16by9">
