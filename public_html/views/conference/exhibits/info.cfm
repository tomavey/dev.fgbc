...
<div id="exhibitorguidelines" class="container">
    ...
    <ul>
        <li>Table with floor length cover: <cfif natmin>$350 <cfelse>$700 </cfif>per table.</li>
    ...
    <p>Shipping information will be sent before June 1st to each exhibitor upon receipt of an official request with payment. Please send your request on the form below as soon as possible.</p>
