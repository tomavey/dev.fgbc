...
<head>
    ...
    <link rel="stylesheet" href="http://www.access2017.com/assets/js/rs-plugin/css/settings.css" type="text/css">
    <link rel="stylesheet" href="http://www.access2017.com/assets/js/rs-plugin/css/fullwidth.css" type="text/css">

    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,400,300,700" rel="stylesheet" type="text/css">
    <link href="http://www.access2017.com/assets/icons/pictopro-normal/style.css" rel="stylesheet" type="text/css">
    <link href="http://www.access2017.com/assets/icons/pictopro-outline/style.css" rel="stylesheet" type="text/css">

    <link rel="stylesheet" href="http://www.access2017.com/assets/fancybox/jquery.fancybox.css" type="text/css">
    <link rel="stylesheet" href="http://www.access2017.com/assets/css/infine.css" type="text/css">

    <!--[if lt IE 9]>
        <link rel="stylesheet" id="ie8-css"  href="http://www.access2017.com/assets/css/ie8.css" type="text/css" media="all">
    <![endif]-->
                ...
                <div class="navbar-collapse collapse" id="main-navbar">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#nav-header">Home</a></li>
                            <li><a href="http://www.access2017.com/#nav-schedule">Schedule</a></li>
                            <li><a href="http://www.access2017.com/#nav-subscribe" target="_blank">Subscribe</a></li>
                            <li><a href="http://www.access2017.com/#nav-lodging">Lodging</a></li>
                            <li><a href="http://www.access2017.com/#nav-childcare">Childcare</a></li>
                            <cfif workshopsRegOpen()>
                                <li><a href="/index.cfm/conference.courses/list/cohort">Cohorts</a></li>
                            </cfif>
                            <li><a href="http://www.access2017.com/#nav-contact" target="_blank">Contact</a></li>
                ...
                <div class="item col-md-4">
                    ...
                    <address>
                        ...
                        <div class="address-content">
                                ...
                                <a href="mailto:tomavey@fgbc.org" class="e-mail">tomavey@fgbc.org</a>
        ...
        <div class="container">
            <div class="row footer-bottom-wrapper">
                ...
                <div class="icons right">
                    <a href="#" class="social-icon"><img src="http://www.access2017.com/assets/icons/icon-twitter.png" alt=""></a>
                    <a href="#" class="social-icon"><img src="http://www.access2017.com/assets/icons/icon-facebook.png" alt=""></a>
                    <a href="#" class="social-icon"><img src="http://www.access2017.com/assets/icons/icon-youtube.png" alt=""></a>
                </div><!-- /.icons -->
            </div><!-- /.row -->
        </div><!-- /.container -->
    </div><!-- /.footer bottom -->
