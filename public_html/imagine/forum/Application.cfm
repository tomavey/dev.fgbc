...
<cfif not isDefined("application.init") or isDefined("url.reinit")>
	...
	<cfinvoke component="cfcs.objectfactory" method="init" settings="#settings#" />

	<!--- Get main settings --->
	<!---cfset application.settings = application.factory.get('galleonSettings').getSettings()--->
	<cfinvoke component="cfcs.objectfactory" method="get" objName="galleonSettings" returnvariable="application.settings" />
